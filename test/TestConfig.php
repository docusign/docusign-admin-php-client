...
class TestConfig
{
    ...
    /**
      * $apiClient
      * @var DocuSign\Admin\Client\ApiClient
      */
    protected $apiClient;
    ...
    {
        $this->host = !empty($host) ? $host : 'https://api-d.docusign.net/management';
    ...
    /**
     * Gets apiClient
     * @return DocuSign\Admin\Client\ApiClient
     */
    ...
    /**
     * Sets apiClient
     * @param DocuSign\Admin\Client\ApiClient $apiClient
     * @return $this
     */
