...
/**
 * DSGroupRequest Class Doc Comment
 *
 * @category    Class
 * @package     DocuSign\Admin
 * @author      Swagger Codegen team <apihelp@docusign.com>
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DSGroupRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DSGroupRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ds_group_id'] === null) {
            $invalidProperties[] = "'ds_group_id' can't be null";
        }
