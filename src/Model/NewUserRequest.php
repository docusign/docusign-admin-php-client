...
class NewUserRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'accounts' => '\DocuSign\Admin\Model\NewUserRequestAccountProperties[]',
        'user_name' => '?string',
        'first_name' => '?string',
        'last_name' => '?string',
        'email' => '?string',
     ...
     * Gets accounts
     *
     * @return \DocuSign\Admin\Model\NewUserRequestAccountProperties[]
     */
     ...
     * Sets accounts
     *
     * @param \DocuSign\Admin\Model\NewUserRequestAccountProperties[] $accounts accounts
     *
     * @return $this
     */
