...
/**
 * ProductPermissionProfileRequest Class Doc Comment
 *
 * @category    Class
 * @package     DocuSign\Admin
 * @author      Swagger Codegen team <apihelp@docusign.com>
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProductPermissionProfileRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProductPermissionProfileRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['permission_profile_id'] === null) {
            $invalidProperties[] = "'permission_profile_id' can't be null";
        }
     ...
     *
     * @param ?string $permission_profile_id permission_profile_id
     *
     * @return $this
     */
